...
def button(KEY, msg,x,y,w,h,ic,ac,action=None):
    gameExit = False
    while not gameExit:
...
# Selection Function
            selection(KEY, msg,x,y,w,h,ic,ac,action=None)
                
def selection(KEY, msg,x,y,w,h,ic,ac,action=None):
...
def game_intro():
    ...
    MenuMusic()
    test("Play!", 150,450,100,50, green, bright_green)
    test("Quit...", 550,450,100,50, red, bright_red)
