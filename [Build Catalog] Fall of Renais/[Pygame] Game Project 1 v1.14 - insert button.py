...
def game_character_loop():
    ...
    button("Eirika", 150, 525, 100, 50, character_unselected_color, character_selected_color)
    button("Ephraim", 550, 525, 100, 50, character_unselected_color, character_selected_color)
    pygame.display.update()
    intro = True
    while intro:
        for event in pygame.event.get():
